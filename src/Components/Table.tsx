...
export default function TableList({ EditModalState, DeleteModalState } : { EditModalState : any , DeleteModalState : any} ) {
    return (
        <>
            <div className="overflow-x-auto">
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            {
                                Array("Nome", "Email", "Cargo").map((item) => (<th scope="col" className="px-4 py-4">{item}</th>))
                            }
                        ...
                        <tr className="border-b dark:border-gray-700">
                            ...
                            <td className="px-4 py-3 flex items-center justify-end">
                                <div className="py-1 text-sm flex gap-1">
                                    <button onClick={ ()=> EditModalState(true) } type="button" className="flex w-full items-center py-2 px-4 hover:scale-110 duration-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="size-6">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                        </svg>
                                    </button>
                                    <button onClick={ ()=> DeleteModalState(true) }  type="button" className="flex w-full items-center py-2 px-4 text-red-500 hover:scale-110 duration-300">
